...
> Here, let us explore unknown areas together, including cryptocurrency, technology, science, culture, products, major events, artificial intelligence, tourism, food, and more. My goal is to provide readers with interesting, useful, and inspiring content to help them grow themselves and open up new horizons together.
...
```yml
title: Epoch
subtitle: Explore unknown areas and open new horizons
description: Here, let us explore unknown areas together, including cryptocurrency, technology, science, culture, products, major events, artificial intelligence, tourism, food, and more. My goal is to provide readers with interesting, useful, and inspiring content to help them grow themselves and open up new horizons together.
keywords:
# 作者名称，会显示在侧边栏
author: Ya
```
...
```yml
card_author:
  description: Explore unknown areas and open new horizons
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/epoch.gostar.top.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
